...
const roleIconMap = {
    ...
    [MemberRole.ADMIN] : <ShieldAlert className="h-4 w-4 mr-2 text-rose-500"></ShieldAlert>
}
            ...
            <ScrollArea className=" flex-1 px-3">
                ...
                {!!textChannels?.length && (
                    <div className="mb-2">
                        ...
                        {textChannels.map((channel)=>{
                            return <ServerChannel key={channel.id} channel={channel} role={role} server={server}></ServerChannel>
                        })}
                    </div>
                )}
                ...
                {!!members?.length && (
                    <div className="mb-2">
                        ...
                        />
                        {members.map((member)=>{
                            return <ServerMember key={member.id} member={member} server={server}></ServerMember>
                        })}
                    </div>
                )}
